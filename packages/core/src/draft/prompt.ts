...
{"reply": "<one or two sentences for the user, or ONE follow-up question>",
 "draft": null | {
  ...
  "suggestedSources": [
    {"kind": "web_search", "config": {"platform": "reddit", "phrases": ["<exact phrase a poster would write>", ...], "siteScope": "reddit.com/r/<subreddit>"}},
    {"kind": "web_search", "config": {"platform": "linkedin", "phrases": [...]}},
    {"kind": "web_search", "config": {"platform": "x", "phrases": [...]}}
  ],
...
- 3-5 suggestedSources, all of kind "web_search": one per platform (reddit, linkedin, x),
  ...
  reddit_subreddit or reddit_search (no Reddit API access).
